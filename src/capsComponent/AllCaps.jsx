...
const AllCaps = () => {
  return (
    <div className="h-auto w-full flex flex-col gap-y-6 items-center justify-center pb-5 lg:py-10 ">
      ...
      <div className="w-full h-auto grid grid-cols-2  md:grid-cols-2 lg:grid-cols-3 gap-x-3 gap-y-4  md:gap-x-10 md:gap-y-8 items-center px-2 md:px-5">
        ...
        <Card
          bgImg={HufBlack}
          title={'BDT 350TK'}
          subTitle={'HUF Cap(Black) '}
        />
        <Card
          bgImg={NikeWhite}
          title={'BDT 350TK'}
          subTitle={'Nike Cap(White) '}
        />
        <Card
          bgImg={UniversalGray}
          title={'BDT 350TK'}
