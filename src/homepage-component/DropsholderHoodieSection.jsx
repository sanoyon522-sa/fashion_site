...
import Autunm from '../assets/DropsholderHoodie/Washed-DropsholderHoodie-Autunm.jpg';
...
const DropsholderHoodieSection = () => {
  return (
    <div className="h-auto w-full flex flex-col gap-y-6 items-center justify-center pt-10 ">
      <div className="flex flex-col gap-y-2 items-center w-full">
        <h1 className="text-xl md:text-3xl text-olive font-semibold text-center">
          Premium Dropsholder Hoodie Collections
        </h1>
      ...
      <div className="w-full h-auto grid grid-cols-2  md:grid-cols-2 lg:grid-cols-4 gap-x-3 gap-y-4  md:gap-x-10 md:gap-y-5 items-center px-2 md:px-5">
        <Card
          bgImg={Blue}
          title={'BDT 1500TK'}
          subTitle={'Washed-DropsholderHoodie-blue '}
        />
        <Card
          bgImg={Autunm}
          title={'BDT 1500TK'}
          subTitle={'Washed-DropsholderHoodie-Autunm '}
        />
        <Card
          bgImg={Gray}
          title={'BDT 1500TK'}
        ...
        <Card
          bgImg={Black}
          title={'BDT 1500TK'}
          subTitle={'Washed-DropsholderHoodie-black '}
        />
      </div>
      <Link to="/dropshoulderhoodie">
...
export default DropsholderHoodieSection;
